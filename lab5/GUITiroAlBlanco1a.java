...
class MiHebraCalculadoraUnDisparo extends Thread{
	...
	Proyectil4 proyectil;
	JTextField jtxtMensaje;
	CanvasCampoTiro1a campoTiro;
	String mensaje;
	int id;

	MiHebraCalculadoraUnDisparo(Proyectil4 p, JTextField jtxtMensaje, CanvasCampoTiro1a campo,int id){
			...
			try{
				...
				SwingUtilities.invokeAndWait( new Runnable(){
					...
					public void run(){
						...
						System.out.println("soy hebra" + id);
...
public class GUITiroAlBlanco1a {
	...
	JButton            btnDispara;
	MiHebraCalculadoraUnDisparo4 hebra;
	int id=0;
	// --------------------------------------------------------------------------
					...
					public void actionPerformed( ActionEvent e ) {
						...
						try {
							...
							if( ( 0.0 < angulo )&&( angulo < 90 )&&( velocidad > 0 ) ) {
								...
								hebra = new MiHebraCalculadoraUnDisparo4(p, txfMensajes, cnvCampoTiro, id);
								hebra.start();
								id++;
